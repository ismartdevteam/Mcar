...
public class SellerAc extends ActionBarActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSpannableString = new SpannableString("Авто машин");
